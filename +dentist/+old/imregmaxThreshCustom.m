...
function [threshold,zcVal] = imregmaxThresh(varargin)
    ...
    [bkgdRatio,zcVal] = backgroundRatio(thresholds,numMx,ss,verboseFlag);
...
function [bkgdRatio,zcVal] = backgroundRatio(thresholds,numMx,ss,verboseFlag)
