...
%
%   See also CONNDEF, IMEXTENDEDMAX, IMHMAX, IMRECONSTRUCT,
%   IMREGIONALMIN.

%   Copyright 1993-2005 The MathWorks, Inc.
%   $Revision: 1.9.4.7 $  $Date: 2012/10/08 03:20:27 $
...
narginchk(1,2);
validateattributes(varargin{1}, {'numeric','logical','NaN'}, {'real','nonsparse','nonnan'},...
              mfilename, 'I', 1);
I = varargin{1};

if (nargin > 1)
  iptcheckconn(varargin{2},mfilename,'CONN',2);
  conn = varargin{2};
else
