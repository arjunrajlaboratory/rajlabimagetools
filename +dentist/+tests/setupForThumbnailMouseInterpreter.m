function [axH, figH, mockViewportHolder] = setupForThumbnailMouseInterpreter()
    figH = figure(1);
    ...
    mockViewportHolder = dentist.tests.MockThumbnailViewportHolder(axH);
    mockViewportHolder.setThumbnailViewport(viewport);
end
