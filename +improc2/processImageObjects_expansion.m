function processImageObjects_expansion(dirPathOrAnArrayCollection, channelsToProcess)
...
function [processorData, label] = chooseProcessorDataForChannel(channelName)
    switch channelName
        ...
        case 'dapi'
            ...
            label = 'dapiProc';
        otherwise
            processorData = improc2.nodeProcs.aTrousRegionalMaxProcessedData_expansion();
            label = [channelName, ':Expansion_Spots'];
    end
end