function augmentedControls = addImageWindowPlugin(thresholdGUIControls)
    ...
    blobProcessorDataHolder = thresholdGUIControls.blobProcessorDataHolder;
    ...
    resources.blobProcessorDataHolder = blobProcessorDataHolder;
    imageWindowController = improc2.blobAnalyzer.blobReviewGUI.ImageWindowModuleSingleton(resources);
