function Hs = layOutBlobReviewGUICore()
    backgColor = [0.247 0.247 0.247];
    
    Hs.figH = figure('Position',[650 100 255 300],...
        'NumberTitle','off',...
        'Name','improc2.blobReviewGUI',...
        'Resize','on',...
        'Toolbar','none',...
        'MenuBar','none',...
        'Color',backgColor,...
...
%         'XColor','w');
    ...
    Hs.channelMenu = uicontrol('Parent', Hs.figH,...
        'Style', 'popupmenu', 'String', {'empty'}, ...
        'Value', 1, ...
        'Units', 'normalized',...
        'FontSize', 16, ...
        'Position', [0.1 0.85 0.39 0.15]);
...
%     
    ...
    Hs.naviPanel  = uipanel('Parent',Hs.figH,...
        'Units','normalized',...
        'Position',[0.0345 0.6 0.9404 0.2249],...
    ...
    Hs.goodCheck = uicontrol('Parent',Hs.naviPanel,...
        ...
        'String','Good Object',...
        'Value',0);
    Hs.goodBlobCheck = uicontrol('Parent',Hs.naviPanel,...
        'Style','checkbox',...
        'Units','normalized',...
        'Position',[0.2 0.7663 0.4030 0.2262],...
        'String','Good Blobs',...
        'Value',0);
