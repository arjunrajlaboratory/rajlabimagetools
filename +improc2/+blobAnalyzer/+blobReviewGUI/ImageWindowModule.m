classdef ImageWindowModule < handle
    ...
    properties (Access = private)
        ...
        visibilityToggleableBlobDisplayer;
    end
    ...
    methods
        ...
        function setBlobVisibility(p, trueOrFalse)
    ...
    methods (Access = private)
        function build(p, resources)
            ...
            blobProcessorDataHolder = resources.blobProcessorDataHolder;
            ...
            compositeImageMaker = improc2.blobAnalyzer.blobReviewGUI.CompositeImageMaker(...
            ...
            blobPerimProvider = improc2.blobAnalyzer.blobReviewGUI.blobPerimProviderFromProcessorDataHolder(blobProcessorDataHolder);
            blobDisplayer = improc2.blobAnalyzer.blobReviewGUI.blobPerimDisplayer(gui.imgAx, blobPerimProvider);
            visibilityToggleableBlobDisplayer = ...
                dentist.utils.VisibilityToggleableDisplayer(blobDisplayer);
            visibilityToggleableBlobDisplayer.attachVisibilityUIControl(gui.blobCheck);
            ...
            p.visibilityToggleableSegmentationDisplayer = ...
                visibilityToggleableSegmentationDisplayer;
            p.visibilityToggleableBlobDisplayer = ...
                visibilityToggleableBlobDisplayer;
