classdef blobConnectionCollectionOneChannel < ...
...
%         dependencyClassNames = {'improc2.interfaces.FittedSpotsContainer', 'improc2.dataNodes.ChannelStackContainer'};
        dependencyClassNames = {'improc2.txnSites2.ManualExonIntronTxnSites', 'improc2.blobAnalyzer.blobCollectionOneChannel'};
%         dependencyClassNames = {'improc2.txnSites2.IntronOrExonTranscriptionSitesCollection', 'blobCollectionOneChannel'};
...
%             img = channelStkContainer.zMerge;
            ...
            X = txnSiteChannel.ExonXs;
            Y = txnSiteChannel.ExonYs;
        ...
        function p = blobConnectionCollectionOneChannel(parentNodeLabel1, parentNodeLabel2, varargin)
            ip = inputParser;
