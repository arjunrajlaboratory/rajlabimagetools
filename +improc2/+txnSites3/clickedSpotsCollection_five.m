classdef clickedSpotsCollection_five < ...
...
%         [dependencyClassNames{1:length(channels)}] = deal('improc2.interfaces.FittedSpotsContainer');
    ...
    methods
        %Create Object
        function p = clickedSpotsCollection_five(objectHandle, varargin)
            ip = inputParser;
...
%         
        ...
        function deleteClickedSpot(p,x, channels)

            objectHandle = p.objectHandle;

            [rnaChannels] = channels;
            ...
            for k = 1:length(rnaChannels)
                ...
                objectHandle, rnaChannelSwitch, 'clickedSpotsCollection_five');
