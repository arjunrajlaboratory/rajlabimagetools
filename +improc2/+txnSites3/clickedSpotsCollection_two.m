classdef clickedSpotsCollection_two < ...
    ...
    properties (Constant = true)
        dependencyClassNames = {'improc2.interfaces.FittedSpotsContainer', 'improc2.interfaces.FittedSpotsContainer'};
...
%         [dependencyClassNames{1:length(channels)}] = deal('improc2.interfaces.FittedSpotsContainer');
    ...
    methods
        %Create Object
        function p = clickedSpotsCollection_two(objectHandle, varargin)
            ip = inputParser;
...
%         
        ...
        function deleteClickedSpot(p,x)
            ...
            for k = 1:length(rnaChannels)
                ...
                objectHandle, rnaChannelSwitch, 'clickedSpotsCollection_two');
